...
with st.sidebar:
    ...
    # ── Feature Quick Links ──
    st.markdown("""
    <div style="margin-top: 0.8rem; padding: 0.6rem 0.8rem; background: rgba(0,180,216,0.04);
                border: 1px solid rgba(0,180,216,0.08); border-radius: 10px;">
        <div style="font-size: 0.68rem; color: #6B7280; text-transform: uppercase;
                    letter-spacing: 1px; margin-bottom: 0.5rem;">Features</div>
        <div style="font-size: 0.75rem; color: #8B95A8; line-height: 1.8;">
            📊 50+ Interactive Charts<br/>
            🔮 SARIMA & Holt-Winters<br/>
            🎲 Monte Carlo (10k+ sims)<br/>
            ⚡ LP Budget Optimizer<br/>
    ...
    # ── Branding & Links ──
    st.markdown("""
    <div style="position: fixed; bottom: 0; left: 0; width: 21rem; padding: 0.8rem 1rem;
                border-top: 1px solid rgba(0,212,170,0.08); background: rgba(10,14,26,0.95);">
        <div style="text-align: center;">
            <a href="https://github.com/Awais-Analyst/StratForge" target="_blank"
               style="text-decoration: none; font-size: 0.72rem; color: #8B95A8;">
                <span style="font-size: 1rem;">🔗</span> GitHub Repository
            </a>
        </div>
        <div style="text-align: center; margin-top: 0.4rem; font-size: 0.68rem; color: #4B5563;">
            v1.0.0 · 100% Free · Zero API Keys
        </div>
        <div style="text-align: center; margin-top: 0.3rem; font-size: 0.72rem; color: #6B7280;">
            Made with <span style="color: #FF6B6B;">❤️</span> by
            <a href="https://github.com/Awais-Analyst" target="_blank"
               style="color: #00D4AA; text-decoration: none; font-weight: 600;">Awais-Analyst</a>
        </div>
    </div>
    """, unsafe_allow_html=True)
